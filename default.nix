...
, containers, extra, hashable, ListLike, mtl, stdenv, text
, text-icu, time, transformers, unordered-containers
}:
mkDerivation {
  pname = "TSLogAnalyzer";
  version = "0.0.1";
  ...
  libraryHaskellDepends = [
    ...
    hashable ListLike mtl text text-icu time transformers
