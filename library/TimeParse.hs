...
import Data.Time.Format (parseTime, formatTime, ParseTime, FormatTime)
import Prelude.Unicode

data TSDate = TSDate { year ∷ Int, month ∷ Int,  day ∷ Int }
data TSTime = TSTime { hour ∷ Int, minute ∷ Int, second ∷ Int }
